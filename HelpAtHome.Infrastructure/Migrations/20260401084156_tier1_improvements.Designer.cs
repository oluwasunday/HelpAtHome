...
namespace HelpAtHome.Infrastructure.Migrations
{
    ...
    [Migration("20260401084156_tier1_improvements")]
    partial class tier1_improvements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HelpAtHome.Core.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("CaregiverProfileId", "Status", "CreatedAt");

                    b.HasIndex("CaregiverProfileId", "Status", "ScheduledStartDate");

                    b.HasIndex("ClientProfileId", "Status", "CreatedAt");
            ...
            modelBuilder.Entity("HelpAtHome.Core.Entities.CaregiverProfile", b =>
                {
                    ...
                    b.HasIndex("AgencyId", "VerificationStatus");
            ...
            modelBuilder.Entity("HelpAtHome.Core.Entities.FamilyAccess", b =>
                {
                    ...
                    b.HasIndex("ClientUserId", "IsApproved", "IsDeleted");
            ...
            modelBuilder.Entity("HelpAtHome.Core.Entities.SupportTicket", b =>
                {
                    ...
                    b.HasIndex("AssignedToAdminId", "Status");
